...
// 	InsertImpl(EntityDAL.ESConfig<T> config) {
// 		this.config = config;
// 	}
...
// 		List<Map.Entry<EntityDAL.FieldMetadata, Object>> params = new ArrayList<>();
// 		String sql = buildInsertSet(entity, literalsMap, params);
// 		return config.preparedStatementAndDo(sql, s -> {
// 			for (int i = 0; i < params.size(); i++) {
// 				Map.Entry<EntityDAL.FieldMetadata, Object> paramValue = params.get(i);
// 				EntityDAL.FieldMetadata fieldMetadata = paramValue.getKey();
...
// 		}
// 		Map<String, String> literalsMap = validateCollect(literals);
// 		List<Map.Entry<EntityDAL.FieldMetadata, Object[]>> paramsSets = new ArrayList<>();
...
// 					Map.Entry<EntityDAL.FieldMetadata, Object[]> paramValue = paramsSets.get(fc);
// 					EntityDAL.FieldMetadata fieldMetadata = paramValue.getKey();
...
// 	private String buildInsertSet(T entity, Map<String, String> literals, List<Map.Entry<EntityDAL.FieldMetadata, Object>> params) {
// 		Set<String> nonNullSet = new LinkedHashSet<>();
// 		try {
// 			for (EntityDAL.FieldMetadata fm : config.em.byColumn.values()) {
...
// 	private String buildInsertSet(Collection<T> entities, Map<String, String> literals, List<Map.Entry<EntityDAL.FieldMetadata, Object[]>> params) {
// 		Map<String, Map.Entry<EntityDAL.FieldMetadata, Object[]>> nonNullSet = new LinkedHashMap<>();
// 		try {
// 			for (EntityDAL.FieldMetadata fm : config.em.byColumn.values()) {
// 				if (literals.containsKey(fm.fieldMetadata.value())) {
// 					continue;
