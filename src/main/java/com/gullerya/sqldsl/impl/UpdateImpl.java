...
// public class UpdateImpl<T> implements Update<T>, Update.UpdateDownstream {
// 	private final EntityDAL.ESConfig<T> config;
// 	private final Map<String, Map.Entry<EntityDAL.FieldMetadata, Object>> updateSet = new LinkedHashMap<>();
// 	private final Map<String, String> literalsSet = new TreeMap<>();

// 	UpdateImpl(EntityDAL.ESConfig<T> config) {
// 		this.config = config;
// 	}
...
// 			int i = 0;
// 			for (Map.Entry<EntityDAL.FieldMetadata, Object> valueParam : updateSet.values()) {
// 				EntityDAL.FieldMetadata fieldMetadata = valueParam.getKey();
